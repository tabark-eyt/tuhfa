...
class _themeViewState extends State<themeView> {
  ...
  Widget build(BuildContext context) {
    ...
    return Consumer<themeProvider>(builder: (context, theme, _) {
      if (theme.state == ScreenState.busy) {
        return SizedBox();
      }
      ...
      return
        Container(
       child: Column(
          children: theme.model.map((e) {
            imgList.add('https://abualhassan.pythonanywhere.com'+e.image.toString());
            titleList.add(e.title.toString());
            List<Widget>  imageSliders = imgList.map((item) =>GestureDetector(
              onTap: () {
                Navigator.push(
                  context,
